import getPostDetails from "@/app/lib/loadPosts";
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                  ...
                  <div className="flex flex-wrap items-center">
                    <div className="mb-5 mr-10 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src={postsData.author.photo.url}
                            alt="author"
                            fill
                          />
                        </div>
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                          By <span> {postsData.author.name}</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center">
                      <p className="mr-5 flex items-center text-base font-medium text-body-color">
                        ...
                        {moment(postsData.createdAt).format("MMM DD, YYYY")}
                      </p>
                    </div>
                  </div>
                  <div className="mb-5">
                ...
                <div>
                  ...
                  {postsData.content.raw.children.map((typeObj, index) => {
